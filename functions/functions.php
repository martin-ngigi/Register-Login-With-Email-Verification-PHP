...
function createuser($first_name, $last_name, $username, $email, $password)
{
    ...
    var_dump("NB: Please copy the directory url accordingly from localhost/.../activate.php \n\n eg: http://localhost/php/Register-Login-With-Email-Verification-PHP//activate.php?email=martinwainaina001@gmail.com&code=44b5a3b6fa8768acdc1c15fc52aa37e0  \n\n\n ACTIVATION LINK: $url/activate.php?email=$email&code=$token");
    //redirect('index.php');
}
